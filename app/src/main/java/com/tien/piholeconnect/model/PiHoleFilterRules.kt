...
data class PiHoleFilterRule(
    ...
    @SerialName("enabled") val enabled: Int = 0,
    @SerialName("groups") val groups: List<Int> = listOf(),
    @SerialName("id") val id: Int = 0,
    @SerialName("type") val type: RuleType = RuleType.REGEX_WHITE,
)

@Serializable
data class PiHoleFilterRules(@SerialName("data") val `data`: List<PiHoleFilterRule> = listOf())
